...
@interface CameraController ()<AVCaptureMetadataOutputObjectsDelegate,UIAlertViewDelegate>
...
- (void)customUI{
    ...
    UIButton* quitBtn = [[UIButton alloc]initWithFrame:CGRectMake(10, kScreenHeight-100, 60, 60)];
    [quitBtn setTitle:@"退出" forState:UIControlStateNormal];
    quitBtn.titleLabel.textAlignment = NSTextAlignmentCenter;
